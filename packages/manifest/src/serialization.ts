 ...
 */
export function serializeManifest(manifest: RepositoryManifest): string {
 ...
 */
export function deserializeManifest(json: string): RepositoryManifest {
  try {
 ...
 */
export function validateManifest(manifest: unknown): manifest is RepositoryManifest {
 ...
 * @returns true if valid, throws error otherwise
 */
export function validateRepository(repository: unknown): repository is Repository {
