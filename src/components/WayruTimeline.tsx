...
export function WayruTimeline({ phase, onMilestoneSelect }: WayruTimelineProps) {
  ...
  return (
    <>
      <div 
        className={`fixed right-0 top-0 h-screen w-[420px] z-20 pointer-events-auto transition-all duration-700 ${
          isVisible ? "opacity-100 translate-x-0" : "opacity-0 translate-x-20 pointer-events-none"
        }`}
      >
        {/* Gradient overlay for blending */}
        <div className="absolute inset-0 bg-gradient-to-l from-[#0a0e1a]/95 via-[#0a0e1a]/80 to-transparent pointer-events-none" />
        ...
        <div 
          ref={timelineRef}
          className="absolute top-[220px] bottom-40 left-0 right-0 overflow-y-auto scrollbar-hide px-4"
          style={{ 
        ...
        >
          ...
          {/* Timeline line */}
          <div className="absolute left-8 top-0 bottom-0 w-[2px] bg-gradient-to-b from-cyan-500/50 via-cyan-400/30 to-cyan-500/50" />
            ...
            {timelineEvents.map((event, index) => {
              ...
              return (
                ...
                >
                  ...
                  <div 
                    className={`absolute left-[22px] top-3 w-4 h-4 rounded-full border-2 transition-all duration-500 ${
                      isCurrent 
                  ...
                  {/* Event card */}
                  <div 
                    className={`backdrop-blur-sm rounded-lg p-3 border transition-all duration-500 relative overflow-hidden ${
                      isCurrent 
                  ...
                  >
                    ...
                    {/* Title */}
                    <h4 
                      className={`font-bold mb-1 transition-colors ${isCurrent ? "text-white" : "text-gray-300"}`}
                      style={{ fontFamily: "'Space Grotesk', sans-serif" }}
                    >
                      {event.title}
                    </h4>
        ...
        <div 
          className={`absolute bottom-4 left-0 right-0 p-4 transition-all duration-500 ${
            activeIndex === timelineEvents.length - 1 ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4 pointer-events-none"
          }`}
        >
          <div className="backdrop-blur-md bg-[#0a0e1a]/60 rounded-lg p-3 border border-cyan-500/20">
            <div className="flex items-center justify-between text-xs">
              <span className="text-cyan-500/70 font-mono">2021-03</span>
              ...
              <span className="text-cyan-500/70 font-mono">2025-11</span>
            </div>
